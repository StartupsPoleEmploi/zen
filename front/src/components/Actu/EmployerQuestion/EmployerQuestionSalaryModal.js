...
export default function EmployerQuestionSalaryModal(props) {
  const {
    index, onChange, onClose, isOpened, activeMonth,
  } = props;
  ...
  const onSubmit = () => {
    onChange(Number(salary.value) + Number(partial.value));
    onClose();
  };
      ...
      content={(
        <div style={{ textAlign: 'left' }}>
                ...
                label={renderLabel({
                  ...
                  content: (
                    <>
                      ...
                      <b>net</b>
                      de votre activité partielle payé par votre employeur.
          ...
          <div style={{ display: 'flex' }}>
            ...
            <Typography style={{ textAlign: 'left' }}>
              Si vous déclarez un salaire brut et une indemnité d'activité partielle,
              les deux montants seront addictionnés dans la case Total €.
