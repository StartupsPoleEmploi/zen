...
function Codiv19Justif({ whiteBg = false }) {
  ...
  return (
    <Container whiteBg={whiteBg}>
      ...
      <Text>
        <Title>
          Justificatif Attestation d'activité partielle <span style={{ color: errorOrange }} >COVID-19</span>
        </Title>
        <Typography>
          ...
          <ul>
            <li>
              ...
              {' '}
              et envoyer l'attestation activité partielle dans la cotégorie Bullettin de salaire.
            </li> 
          </ul>
        </Typography>
      </Text>
