...
import LoginErrorDialog from '../../components/Actu/LoginErrorDialog'
...
export class Home extends Component {
  ...
  componentDidMount() {
    if (this.props.location.search === '?loginFailed') {
      this.setState({ isErrorModalOpened: true }) // eslint-disable-line
    }
  }

  closeModal = () => this.setState({ isErrorModalOpened: false })
