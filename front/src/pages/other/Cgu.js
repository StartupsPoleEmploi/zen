...
import { H1, H4 } from '../../components/Generic/Titles'
...
function Title3({ children }) {
  const classes = useStyles()
  return (
    <Typography className={classes.title3} component="span">
  ...
  return (
    <div container className={classes.container}>
      ...
      <Typography>
        ...
        75020 Paris. Tél : 33(0)140306000 L’hébergeur du service est OVH (2 rue
        Kellermann 59100 Roubaix - 09 72 10 10 07)
      </Typography>
      ...
      <Typography>
        ...
        justificatifs à transmettre selon votre déclaration. ZEN additionne pour
        vous vos heures travaillées et totalise vos revenus mensuels.
        <br />
        ZEN transmets tous vos justificatifs dans votre espace personnel sur
        pole-emploi.fr.
        <br />A partir de cette déclaration, Pôle emploi renouvelle
        l’inscription sur la liste des demandeurs d’emploi pour le mois suivant
        conformément à l’article L. 5411-2 du code du travail et calcule le
        montant des allocations dues pour les mois passés conformément à
        l’article L. 5425-1 du code du travail.
      </Typography>
      ...
      <Typography>
        ...
        <br />
        Vos données sont destinées aux agents de Pôle emploi.
        <br />
      ...
      <Typography color="primary" className={classes.cookieContainer}>
        <b>Mailjet</b>
        <br />
        ...
        <br />
        Finalites : Ce cookie est utilisé par Google Analytics pour diminuer le
        taux de requêtes en cas de fort trafic.
        <br />
      ...
      <Typography>
        ...
        d’utilisation.
        <br />
        Les déclarations doivent être effectuées de bonne foi.
        <br />
