...
# 2-59/5 * * * * mkdir -p /home/docker/zen/logs/ && /home/docker/zen/script/control-mounted-volum.sh zen_node_1 datalakepe >> /home/docker/zen/logs/control-mounted-volum.log
# */5 * * * * mkdir -p /home/docker/zen/logs/ && /home/docker/zen/script/control-mounted-volum.sh zen_cron_1 datalakepe >> /home/docker/zen/logs/control-mounted-volum.log
